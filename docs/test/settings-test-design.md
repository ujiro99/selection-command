...
- [ ] ES-12: 正常系: ユーザー設定セクションの取得
  - [ ] ES-12-a: 正常系: ユーザー設定セクションのcommandsには、コマンドセクションのデータがマージされること
  - [ ] ES-12-b: 正常系: ユーザー設定セクションのcommandsには、OptionSettingsが含まれること
...
### `src/hooks/useSettings.ts` のテスト項目
...
- [ ] US-27: 正常系: IconUrlsマップの生成
  - コマンドのキャッシュ前のアイコンURLをマップから取得できること
  - フォルダーのキャッシュ前のアイコンURLをマップから取得できること
