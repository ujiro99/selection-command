...
const lang = {
  ...
  uninstallForm: {
    ...
    wantedToUseTitle: 'Que funcionalidades você queria usar? (múltipla escolha)',
    wantedToUsePlaceholder: 'Por favor, nos diga o que você queria fazer',
    ...
    wantedToUse: {
      ...
      link_preview: 'Pré-visualização de links',
      [OTHER_OPTION]: 'Outro',
    },
    reasons: {
