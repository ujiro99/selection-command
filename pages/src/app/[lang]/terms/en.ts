...
1. The Service relates to the Chrome extension "Selection Command" and provides the following functionalities:
   ...
   - The ability for users to retrieve and view commands posted by other users.
...
## 7: Privacy Policy
1. The Service does not require user registration or collect personal information.
2. The Service uses Google Analytics to collect anonymous usage data through cookies. For details, please refer to [Google Analytics Terms of Service](https://www.google.com/analytics/terms/us.html).
