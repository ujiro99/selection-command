...
export const COMMAND_URLS: UrlEntry[] = [
  ...
  { title: "Search Commands on Hub", locale: "en", searchUrl: "https://selection-command.com/en/commands?q=%pageUrl" },
  ...
  { title: "コマンドをHubで検索", locale: "ja", searchUrl: "https://selection-command.com/ja/commands?q=%pageUrl" },
  ...
  { title: "在 Hub 中搜索命令", locale: "zh", searchUrl: "https://selection-command.com/zh-CN/commands?q=%pageUrl" },
  { title: "네이버", locale: "ko", searchUrl: "https://search.naver.com/search.naver?query=%s" },
  { title: "Hub에서 명령어 검색", locale: "ko", searchUrl: "https://selection-command.com/ko/commands?q=%pageUrl" },
  ...
  { title: "Поиск команд в Hub", locale: "ru", searchUrl: "https://selection-command.com/ru/commands?q=%pageUrl" },
  { title: "Befehle im Hub suchen", locale: "de", searchUrl: "https://selection-command.com/de/commands?q=%pageUrl" },
  { title: "Rechercher des commandes sur Hub", locale: "fr", searchUrl: "https://selection-command.com/fr/commands?q=%pageUrl" },
  ...
  { title: "Buscar comandos en Hub", locale: "es", searchUrl: "https://selection-command.com/es/commands?q=%pageUrl" },
  { title: "Pesquisar comandos no Hub", locale: "pt-br", searchUrl: "https://selection-command.com/pt-BR/commands?q=%pageUrl" },
  { title: "Pesquisar comandos no Hub", locale: "pt", searchUrl: "https://selection-command.com/pt-PT/commands?q=%pageUrl" },
  { title: "Hub पर कमांड खोजें", locale: "hi", searchUrl: "https://selection-command.com/hi/commands?q=%pageUrl" },
  ...
  { title: "Cari Perintah di Hub", locale: "id", searchUrl: "https://selection-command.com/id/commands?q=%pageUrl" },
  ...
  { title: "Cari Perintah di Hub", locale: "ms", searchUrl: "https://selection-command.com/ms/commands?q=%pageUrl" },
  { title: "Zalando.it", locale: "it", searchUrl: "https://www.zalando.it/catalogo/?q=%s" },
  { title: "Cerca comandi su Hub", locale: "it", searchUrl: "https://selection-command.com/it/commands?q=%pageUrl" },
]
