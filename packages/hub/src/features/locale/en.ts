...
const lang = {
  ...
  uninstallForm: {
    ...
    wantedToUseTitle: "What features did you want to use? (multiple choice)",
    wantedToUsePlaceholder: "Please tell us what you wanted to do",
    ...
    wantedToUse: {
      search_selected_text: "Search selected text",
      ai_chatbot: "AI chatbot(like ChatGPT)",
    ...
    reasons: {
      ...
      search_engine_is_not_available: "Search engine not available",
      i_dont_know_how_to_add_commands: "Don't know how to add commands",
      settings_are_complicated: "Settings are too complicated",
